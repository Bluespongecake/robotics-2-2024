...
def main(task):
    ...
    if task == 'initPose':
        ...
        # Your code here!
#pos 1
        left_arm.servo_to_pose([0.75, 0.495, -0.05], [0.01, np.pi, 0.01])
        left_arm.gripper_close()
#pos 2
        left_arm.servo_to_pose([0.75, 0.25, 0.1],[0.01, np.pi, 0.01])
        left_arm.servo_to_pose([0.75, 0.025, -0.05],[0.01, np.pi, 0.01])
        left_arm.gripper_open()
#pos 3
        left_arm.servo_to_pose([0.75, 0.025, 0.1],[0.01, np.pi, 0.01])
        left_arm.servo_to_pose([0.75, 0.5, 0.1],[0.01, np.pi, 0.01])
#pos 4
        right_arm.servo_to_pose([0.75, 0.025, 0.1], [0.01, np.pi, 0.01])
        right_arm.servo_to_pose([0.75, 0.025, -0.05], [0.01, np.pi, 0.01])
        right_arm.gripper_close()
#pos 5
